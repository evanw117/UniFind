...
function FeatureDetails() {
  const features = [
    ...
    },
    {
      ...
      steps: [
        { title: "Natural Language Search", desc: "Search using everyday language—not exact phrases" },
        { title: "Semantic Matching", desc: "Our AI understands context and meaning" },
        { title: "Fuzzy Matching", desc: "Finds items even with typos or different descriptions" },
        { title: "Campus Filtering", desc: "Narrow by campus, location, or category" },
        { title: "Real-Time Results", desc: "See new items as soon as they're reported" },
        { title: "Smart Ranking", desc: "Most relevant items appear first" },
      ],
      reward: "Find faster",
    },
    {
